...
**User-scoped responses are not cached.** Private Collections are not stored in the response cache, and Collections routes run the [ADR-0007](./0007-collections-only-permission-check.md) permission check before any response-cache read.