...
- `src/` — Fastify service.
  ...
  - `versions/v1-alpha/contributors/` — the same rules for Contributors endpoints, which register `/projects/:slug/contributors/<filename>`. The alpha plugin skips this folder until its first route exists.
