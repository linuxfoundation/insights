...
| `429`       | `rate_limited`       | You have exceeded your organization's rate limit. See `Retry-After`.      |
...
When you exceed your rate limit, the API returns `429` with `code: rate_limited`, plus a
