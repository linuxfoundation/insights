...
- One more repository, CI pipeline, and deployment to own. Insights delivers a service that runs on a cluster operated by the platform DevOps team, which needs explicit hosting and on-call agreement (tracked under T-015).
