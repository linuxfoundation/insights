...
### API keys stored in Auth0 — [api/docs/arch/adr/0015](../adr/0015-api-keys-stored-in-auth0.md)
...
### API keys are long-lived, no auto-expiry — [api/docs/arch/adr/0006](../adr/0006-long-lived-api-keys.md)
...
### Pagination: `page` + `pageSize`, zero-indexed — [api/docs/arch/adr/0011](../adr/0011-pagination-page-pagesize-zero-indexed.md)
