...
const IssuesResolutionSummary = Type.Object(
  {
    ...
    previous: describe(
      ...
      'Issues closed in the comparison period, which ends the day before `periodFrom`. Its span is derived in calendar months and days, so its elapsed days can differ from the current period (count).',
    ),
