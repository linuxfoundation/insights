...
// This is a copy of the tinybird.ts file in the frontend/server/data/tinybird directory.
// It is done this way until we decide on a more permanent structure for the project, and where to place shared code.
