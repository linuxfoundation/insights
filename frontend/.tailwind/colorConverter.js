// TODO: this needs to be converted to TS
const fs = require('fs');
const path = require('path');

const colorVariables = path.resolve(`${__dirname}/../assets/styles/variables/_colors.scss`);
...
function getThemeReplacementsValues() {
  ...
  return Object.keys(colorHexes).reduce(
    (map, key) => ({
      ...map,
