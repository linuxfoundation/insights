...
const queryKey = computed(() => [TanstackKey.ORGANIZATION_PAGE_CONTRIBUTORS_TIMESERIES, orgSlug]);

const { data, isLoading, isError } = useQuery<OrgContributorTimeseries[]>({
  queryKey,
  queryFn: ORGANIZATION_PAGE_API_SERVICE.fetchContributorTimeseries(orgSlug),
});
