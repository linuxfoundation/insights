...
export const lfxOspsBaselineScore: OspsBaselineScore[] = [
  {
    ...
    label: 'Excellent',
    description:
      'No critical issues were detected and most assessments meet or exceed best practices.',
  ...
  },
  {
    ...
    label: 'Good',
    description:
      'Moderate adherence to best practices, with minor weaknesses that to not pose immediate risks.',
    lineColor: lfxColors.positive[500],
  ...
  },
  {
    ...
    label: 'Poor',
    description:
      'The project is exposed to significant risks,' +
  ...
  },
  {
    ...
    label: 'Very poor',
    description:
      'The project is highly vulnerable to attacks and is not following standard security practices.',
  ...
  },
  {
    ...
    label: 'Critical',
    description:
      'Immediate and comprehensive remediation is required to establish a baseline security posture.',
    lineColor: lfxColors.negative[500],
