...
<template>
  <div class="flex flex-col gap-6">
    ...
    <lfx-field label="Project name">
      <lfx-input v-model="model.project.name" />
    </lfx-field>

    <!-- Project homepage -->
    <div class="flex flex-col gap-1">
      <lfx-field label="Project homepage">
        <p class="text-body-2 text-neutral-500 mb-1">Project or repository main website</p>
        <lfx-input
    ...
    <div class="flex flex-col gap-1">
      <lfx-field label="Funding URL">
        <p class="text-body-2 text-neutral-500 mb-1">Project sponsorship website</p>
        <lfx-input
