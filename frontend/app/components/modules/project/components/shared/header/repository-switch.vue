...
import LfxProjectRepositorySearch
  from "~/components/modules/project/components/shared/header/repository-switch/repository-search.vue";
import LfxProjectRepositoryGroupSearch
  from "~/components/modules/project/components/shared/header/repository-switch/repository-group-search.vue";
