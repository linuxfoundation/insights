    ...
    >
      ...
      <template #content>
        ...
        >
          ...
          >
            <lfx-menu-button class="!text-neutral-900 !rounded-md flex !items-start gap-2">
              <lfx-icon
                name="circle-user"
                class="mt-1"
              />
              <div class="flex-col gap-1">
                Manage profile
                <p class="text-xs text-neutral-500">LFX Individual Dashboard</p>
              </div>
            </lfx-menu-button>
          </a>
          <lfx-menu-button
            ...
            @click="logoutHandler()"
          >
            <lfx-icon name="arrow-right-from-bracket" />
            Log out
          </lfx-menu-button>
        </div>
      </template>
