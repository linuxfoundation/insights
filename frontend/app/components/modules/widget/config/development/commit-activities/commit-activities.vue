...
const emit = defineEmits<{
  (e: 'update:modelValue', value: CommitActivitiesModel): void;
...
const commitActivities = computed<CommitActivities | undefined>(() =>
  model.value.activeTab === 'cumulative'
...
const chartData = computed<ChartData[]>(
  ...
  () => {
    let tmpData = convertToChartData(
      commitActivities.value?.data as RawChartData[],
      'startDate',
      ['commits'],
      undefined,
      'endDate',
