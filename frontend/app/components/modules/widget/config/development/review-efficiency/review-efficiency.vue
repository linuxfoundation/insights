  ...
  <section class="mt-5">
    <div>
      <div class="flex flex-row justify-between items-start">
        <div>
          <div class="text-neutral-400 text-xs mb-1">Closed/Opened pull requests ratio</div>
          <lfx-skeleton-state
            :status="status"
            height="2rem"
            width="7.5rem"
...
const openedSummary = computed<Summary | undefined>(() => reviewEfficiency.value?.openedSummary);
const closedSummary = computed<Summary | undefined>(() => reviewEfficiency.value?.closedSummary);
