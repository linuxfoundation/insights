...
const title = `${name || 'Repository'} development insights | ${project?.name} | LFX Insights`;
const description = `Explore ${name || ''}development insights${project?.name ? ` under the ${project.name}` : ''}.`;
