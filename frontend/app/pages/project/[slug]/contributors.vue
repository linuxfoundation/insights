...
const imageAlt = `${project?.name} contributor insights${(widget && lfxWidgets[widget as Widget]?.name?.length)
    ? ` - ${lfxWidgets[widget as Widget]?.name}`
    : ''}`;
const description = `Explore ${project?.name} contributor insights`;
