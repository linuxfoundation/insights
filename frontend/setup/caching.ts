  ...
  routeRules:
    process.env.NUXT_APP_ENV === 'production'
      ? {
          ...
          '/auth/callback': { redirect: '/auth/auth0/callback' }, // Disable SSR for Auth0 callback page
      ...
      : {
          '/callback': { redirect: '/auth/auth0/callback' }, // Redirect legacy callback to OIDC callback
          '/auth/callback': { redirect: '/auth/auth0/callback' }, // Disable SSR for Auth0 callback page in development too
