...
const description =
  'LFX Insights helps you evaluate the health of open source projects through trusted metrics. ' +
  'Backed by the Linux Foundation.';
const keywords =
  'LFX Insights, open source analytics, contributor tracking, software security, ' +
  'project collaboration, developer insights, Linux Foundation';

const shortDescription =
  'Track contributor activity, analyze trends, and boost collaboration with real-time ' +
