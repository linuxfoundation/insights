...
import type {RetentionDataPoint, RetentionResponse} from "~~/server/data/tinybird/contributors/retention-data-source";
...
describe('Retention Data Source', () => {
  ...
  test('should fetch contributors retention data with correct parameters', async () => {
    ...
    const {fetchRetention} = await import("~~/server/data/tinybird/contributors/retention-data-source");
