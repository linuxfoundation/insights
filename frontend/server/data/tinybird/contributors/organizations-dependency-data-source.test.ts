...
import type {OrganizationDependencyResponse} from "~~/server/data/tinybird/contributors/organizations-dependency-data-source";
...
describe('Organizations Dependency Data Source', () => {
  ...
  test('should fetch organizations dependency data with correct parameters', async () => {
    ...
    const {fetchOrganizationDependency} = await import("~~/server/data/tinybird/contributors/organizations-dependency-data-source");
